...
function Input({
  ...
  const inputClassName = cn(
    'h-8.5 w-full min-w-0 rounded-[inherit] px-[calc(--spacing(3)-1px)] leading-8.5 outline-none placeholder:text-primary-600/70 sm:h-8 sm:leading-8 [transition:background-color_5000000s_ease-in-out_0s]',
    size === 'sm' &&
      'h-8 px-[calc(--spacing(2.5)-1px)] leading-8 sm:h-8 sm:leading-8',
