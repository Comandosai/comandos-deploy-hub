        ...
        <TooltipProvider>
          <TooltipRoot>
            ...
            >
              ...
              <span className="text-[11px] font-medium">Повторить</span>
            </TooltipTrigger>
            <TooltipContent side="top">Отправить сообщение ещё раз</TooltipContent>
          </TooltipRoot>
        </TooltipProvider>
      )}
      <TooltipProvider>
        <TooltipRoot>
          ...
          <TooltipContent side="top">Копировать</TooltipContent>
        </TooltipRoot>
      </TooltipProvider>
