...
export function WaveChatPanelsShowcase() {
  return (
    <main
      aria-label="Демонстрация панелей Wave Chat"
    ...
    >
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-8">
        <header className="rounded-[28px] border border-[#d9b35f]/35 bg-black/28 p-5 shadow-2xl backdrop-blur-xl">
          <p className="text-[11px] font-black uppercase tracking-[0.28em] text-[#d9b35f]/72">Панели Wave Chat</p>
          <h1 className="mt-2 font-serif text-4xl font-black text-[#ffe7a3]">Демонстрация компонентов</h1>
          <p className="mt-2 max-w-3xl text-sm text-[#f9e7b5]/68">
            Поверхность для проверки инвентаря, диалога задания, карты и хранилища основателя. Это настоящие React-компоненты, а не PNG-макеты.
          </p>
        </header>
