          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                className="flex min-w-[150px] items-center justify-center gap-1.5 rounded-xl px-4 py-2 text-sm font-semibold transition-opacity hover:opacity-90"
                style={{ background: 'var(--theme-accent)', color: '#111' }}
              >
        ...
        <div className="rounded-2xl border border-primary-200 bg-primary-50/85 p-4 backdrop-blur-xl">
          <div className="relative">
            ...
            <input
              ...
              className="min-h-8 w-full rounded-lg border border-[var(--theme-border)] bg-[var(--theme-input)] py-1.5 pl-8 pr-3 text-xs text-[var(--theme-text)] placeholder:text-[var(--theme-muted)] focus:outline-none focus:ring-1 focus:ring-[var(--theme-accent)]"
            />
          </div>
          {profilesQuery.isError ? (
            ...
            >
              Список профилей не загрузился. Новые задания будут создаваться в
              профиле по умолчанию, пока список не обновится.
            </p>
          ) : null}
        </div>
        ...
        <div className="flex-1 space-y-2 overflow-y-auto px-4 py-3">
          {jobsQuery.isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center py-12 text-[var(--theme-muted)]">
              ...
              />
              <p className="text-sm font-medium">Заданий по расписанию нет</p>
              <p className="mt-1 text-xs">
                Cron-задачи в профилях COMANDOS Hermes не найдены
              </p>
            </div>
          ) : (
            <AnimatePresence mode="popLayout">
              {filteredJobs.map((job) => (
                <JobCard
                  ...
                  onDelete={(id) => {
                    if (confirm(`Удалить задание "${job.name}"?`)) {
