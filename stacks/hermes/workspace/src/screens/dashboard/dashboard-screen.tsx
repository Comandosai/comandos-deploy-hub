...
export function DashboardScreen() {
  ...
  return (
    <div className="min-h-full">
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-2 h-12" style={{ paddingTop: 'env(safe-area-inset-top, 0px)' }}>
        ...
        <button
          ...
          onClick={() => {
            ...
            const cur = document.documentElement.getAttribute('data-theme') || 'komandos-dark'
            const nextDataTheme = LIGHT_DARK_PAIRS[cur] || (isDark ? 'komandos-light' : 'komandos-dark')
      ...
      {/* ── Header: COMANDOS AI command-center lockup. */}
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <img
              ...
              alt="COMANDOS AI Workspace logo"
