...
import { Route as ApiLocalHermesStatusRouteImport } from './routes/api/local-hermes/status'
...
const ApiLocalHermesStatusRoute = ApiLocalHermesStatusRouteImport.update({
  id: '/api/local-hermes/status',
  path: '/api/local-hermes/status',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/api/local-hermes/status': typeof ApiLocalHermesStatusRoute
...
export interface RootRouteChildren {
  ...
  ApiLocalHermesStatusRoute: typeof ApiLocalHermesStatusRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/api/local-hermes/status': {
      id: '/api/local-hermes/status'
      path: '/api/local-hermes/status'
      fullPath: '/api/local-hermes/status'
      preLoaderRoute: typeof ApiLocalHermesStatusRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/api/license/activate': {
      id: '/api/license/activate'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  ApiLocalHermesStatusRoute: ApiLocalHermesStatusRoute,
