...
Команда установки из канонической ветки:
...
Добавь cyberseo.project.yml в .gitignore текущего проекта и ограничь доступ к файлу командой chmod 600 cyberseo.project.yml.
...
Скопируй папку cyberseo-full/assets/wordpress/cyberseo-publisher-stack на сервер и запускай её setup.sh из `main`.
...
Полные пароли не печатай ни в чате, ни в логах. В отчёте укажи только имя поля и путь к защищённому локальному файлу.
...
Логин и пароль не печатай. Сохраняй их только в защищённом и исключённом из Git `cyberseo.project.yml`.
