...
/**
 * Structured data freshness: expose modified timestamp for Yoast schema and OG.
 */
function comandos_blog_modified_time_iso8601(): string {
    if (!is_singular('post')) {
        return '';
    }
    ...
    return (string) get_post_modified_time(DATE_W3C, true, $post_id);
}

add_filter('wpseo_schema_article', function ($data) {
    $modified = comandos_blog_modified_time_iso8601();
    if ($modified !== '') {
