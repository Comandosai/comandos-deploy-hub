...
9. Создает `products_live_readable.md` рядом с `products_live.tsv` для удобной визуальной проверки
...
- переносит `products_live_readable.md` в `vectorized/`, если preview был сгенерирован;
