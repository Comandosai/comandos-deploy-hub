...
## Команда 5. Поднять или подключить `Supabase`
...
## Команда 6. Векторизовать данные
...
## Команда 7. Подключить отдел продаж
...
## Команда 8. Протестировать бота в Telegram
...
## Команда 11. Собрать промпт квалификатора
